 ...
 */
final class Version20260926153929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE effect (id BLOB NOT NULL, code VARCHAR(50) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B66091F277153098 ON effect (code)');
        $this->addSql('CREATE TABLE monster (id BLOB NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, current_health INTEGER DEFAULT 0 NOT NULL, max_health INTEGER DEFAULT 0 NOT NULL, defense INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE monster_effect (monster_id BLOB NOT NULL, effect_id BLOB NOT NULL, PRIMARY KEY (monster_id, effect_id), CONSTRAINT FK_B0A0DCD1C5FF1223 FOREIGN KEY (monster_id) REFERENCES monster (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B0A0DCD1F5E9B83B FOREIGN KEY (effect_id) REFERENCES effect (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
